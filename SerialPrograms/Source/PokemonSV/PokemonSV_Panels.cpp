...
#include "Programs/ShinyHunting/PokemonSV_ShinyHunt-WaterfallCave.h"
...
//    ret.emplace_back("---- Sandwiches ----");
    ...
    ret.emplace_back(make_single_switch_program<ShinyHuntWaterfallCave_Descriptor, ShinyHuntWaterfallCave>());
